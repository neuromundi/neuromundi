 ...
 * dejarla escrita en el repositorio.
 *
 * Se conserva el estilo `light_all` (minimalista) que ya usaba el directorio.
 * Si la variable no está definida, la URL queda sin `?key=` y el mapa sigue
 * funcionando, solo que con la marca de agua.
 */
