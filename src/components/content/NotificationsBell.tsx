...
import { Bell, Trophy, Award, CalendarClock, Megaphone, MessageSquare, Users, Gift, HandCoins, Compass, PauseCircle, AlertTriangle, Briefcase, Ticket, MailOpen } from 'lucide-react';
