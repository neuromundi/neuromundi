        ...
        <div className="mt-3 flex gap-2">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full rounded-lg border border-slate-200 py-2 pl-9 pr-3 rtl:pl-3 rtl:pr-9 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
            />
          </div>
