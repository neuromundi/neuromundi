...
const es: LegalBundle = {
  ...
  manifesto: {
    ...
    lead: 'Vivimos en un mundo diverso, con mentes únicas y ritmos de desarrollo distintos. Durante demasiado tiempo, el camino del neurodesarrollo, la neurodivergencia y las afecciones neurológicas se ha recorrido desde la fragmentación, la dispersión de información y, muchas veces, la soledad. Hoy decidimos cambiar esa realidad.',
    intro: [
...
const en: LegalBundle = {
  ...
  manifesto: {
    ...
    lead: 'We live in a diverse world, with unique minds and different developmental rhythms. For too long, the path of neurodevelopment, neurodivergence and neurological conditions has been walked through fragmentation, scattered information and, all too often, loneliness. Today we decide to change that reality.',
    intro: [
